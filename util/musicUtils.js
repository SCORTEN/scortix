...
module.exports = client => {
    ...
    client.sendQueueUpdate = async (guildId) => {
        ...
        const songEmbed = new Discord.MessageEmbed().setColor("#2f3136")
            .setTitle(`${song.title}`)
.setFooter({ text: `Scortix bot was made by - 🍁Scortennnn🍁#8469`, iconURL: 'https://cdn.discordapp.com/attachments/970636523743633428/1030766124406677584/scorten_ken_kaneki.png'})
